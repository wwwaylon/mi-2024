...
```{r child = "_setup.`{block, box.title = "Exercise 1", box.body = list(fill = "white"), box.icon = "fa-star"}
This is question 1.
```


Got it! Here are the 10 questions in plain text, formatted as requested with code blocks:
